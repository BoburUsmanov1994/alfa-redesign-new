...
const AccountStatusPage = () => {
    ...
    const create = (attrs) => {
        mutate({url: URLS.userStatus, attributes: {...attrs}}, {
            onSuccess: () => {
                setOpen(false)
                ref.current?.reload()
            }
    ...
    const update = (attrs) => {
        updateRequest({
            url:`${URLS.userStatus}/${get(currentRecord,'_id')}`,attributes: {...attrs}
        },{
            onSuccess:()=>{
    ...
    const remove = (_id) => {
        removeRequest({url:`${URLS.userStatus}/${_id}`},{
            onSuccess:()=>{
                ref.current?.reload()
            }
        })
