            ...
            <Datagrid
                ...
                columns={[
                    ...
                    },
                    {
                        title: t('ИНН'),
                        dataIndex: 'inn',
                        render: (_, record) => get(record, 'insurant.organization.inn'),
                        width: 125,
                        align: 'center',
                    },
                    {
...

                    {
                        ...
                        align: 'right',
                        render: (_, record) => Intl.NumberFormat('en-US')?.format(get(record, 'policies[0].insuranceSum', 0)),
                        width: 175
                    },
                    {
                        ...
                        align: 'right',
                        render: (_, record) => Intl.NumberFormat('en-US')?.format(get(record, 'policies[0].insurancePremium', 0)),
                        width: 125
                    },
                    {
                    ...
                    },
                    {
                        ...
                        dataIndex: 'issueDate',
                        render: (text, record) => get(record, 'policies[0].issueDate')? dayjs(get(record, 'policies[0].issueDate')).format('DD.MM.YYYY'):'-',
                        valueType: 'date',
                        align: 'center',
                        width: 100
                    },
                    {
                        ...
                        valueType: 'digit',
                        align: 'right',
                        render: (_, record) => isEqual(get(record,'status'),"payed") ? Intl.NumberFormat('en-US')?.format(get(record, 'policies[0].insurancePremium', 0)):0,
                        hideInSearch: true,
                        width: 125
                    },
                    {
                ...
                {({actionRef}) => <Space>
                    <Button loading={loadingReport} type={'dashed'} icon={<DownloadOutlined/>} onClick={() => {
                        ...
                        request.get(URLS.osgorPortfelReport, {
                            responseType: 'blob',
                            params: {
                                page: current,
                                limit: pageSize,
