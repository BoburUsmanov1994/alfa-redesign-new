...
const ClientTypePage = () => {
    ...
    const create = (attrs) => {
        mutate({url: URLS.personType, attributes: {...attrs}}, {
            onSuccess: () => {
                setOpen(false)
                ref.current?.reload()
            }
    ...
    const update = (attrs) => {
        updateRequest({
            url:`${URLS.personType}/${get(currentRecord,'_id')}`,attributes: {...attrs}
        },{
            onSuccess:()=>{
    ...
    const remove = (_id) => {
        removeRequest({url:`${URLS.personType}/${_id}`},{
            onSuccess:()=>{
                ref.current?.reload()
            }
        })
