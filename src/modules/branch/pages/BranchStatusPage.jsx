...
const BranchStatusPage = () => {
    ...
    const create = (attrs) => {
        mutate({url: URLS.branchStatus, attributes: {...attrs}}, {
            onSuccess: () => {
                setOpen(false)
                ref.current?.reload()
            }
    ...
    const update = (attrs) => {
        updateRequest({
            url:`${URLS.branchStatus}/${get(currentRecord,'_id')}`,attributes: {...attrs}
        },{
            onSuccess:()=>{
    ...
    const remove = (_id) => {
        removeRequest({url:`${URLS.branchStatus}/${_id}`},{
            onSuccess:()=>{
                ref.current?.reload()
            }
        })
