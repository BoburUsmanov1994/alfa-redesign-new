...
const BranchLevelPage = () => {
    ...
    const create = (attrs) => {
        mutate({url: URLS.levelofbranch, attributes: {...attrs}}, {
            onSuccess: () => {
                setOpen(false)
                ref.current?.reload()
            }
    ...
    const update = (attrs) => {
        updateRequest({
            url:`${URLS.levelofbranch}/${get(currentRecord,'_id')}`,attributes: {...attrs}
        },{
            onSuccess:()=>{
    ...
    const remove = (_id) => {
        removeRequest({url:`${URLS.levelofbranch}/${_id}`},{
            onSuccess:()=>{
                ref.current?.reload()
            }
        })
