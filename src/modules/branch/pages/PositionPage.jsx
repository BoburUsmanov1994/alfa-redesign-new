...
const PositionPage = () => {
    ...
    const create = (attrs) => {
        mutate({url: URLS.position, attributes: {...attrs}}, {
            onSuccess: () => {
                setOpen(false)
                ref.current?.reload()
            }
    ...
    const update = (attrs) => {
        updateRequest({
            url:`${URLS.position}/${get(currentRecord,'_id')}`,attributes: {...attrs}
        },{
            onSuccess:()=>{
    ...
    const remove = (_id) => {
        removeRequest({url:`${URLS.position}/${_id}`},{
            onSuccess:()=>{
                ref.current?.reload()
            }
        })
