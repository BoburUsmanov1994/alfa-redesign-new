    ...
    return (
        <>
            <Row gutter={16}>
                ...
                <Col xs={20}>
                    {isEqual(client, 'person') && <Row gutter={16}>
                        ...
                        <Col xs={6}>
                            <Form.Item label={' '}>
                                <Button loading={isPending} icon={<ReloadOutlined/>} onClick={() => getPersonInfo(['responsibleForDamage','person'])}
                                        type="primary">
                                    {t('Найти')}
                                </Button>
                            </Form.Item>
                    ...
                    {isEqual(client, 'organization') && <Row gutter={16}>
                        ...
                        <Col xs={6}>
                            <Form.Item label={' '}>
                                <Button loading={isPending} icon={<ReloadOutlined/>} onClick={() => getOrgInfo(['responsibleForDamage','organization'])}
                                        type="primary">
                                    {t('Найти')}
                                </Button>
                            </Form.Item>
            ...
            {isEqual(client, 'person') ? <Row gutter={16}>
                ...
                <Col xs={6}>
                    <Form.Item name={['responsibleForDamage', 'person', 'fullName', 'lastname']} label={t('Фамилия')}
                               rules={[{required: true, message: t('Обязательное поле')}]}>
                        <Input/>
                    </Form.Item>
                </Col>
                ...
                <Col xs={6}>
                    <Form.Item name={['responsibleForDamage', 'person', 'fullName', 'middlename']} label={t('Отчество')}
                               rules={[{required: true, message: t('Обязательное поле')}]}>
                        <Input/>
                    </Form.Item>
                </Col>
