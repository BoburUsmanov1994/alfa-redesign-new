...
const ProductStatusPage = () => {
    ...
    const create = (attrs) => {
        mutate({url: URLS.statusofproduct, attributes: {...attrs}}, {
            onSuccess: () => {
                setOpen(false)
                ref.current?.reload()
            }
    ...
    const update = (attrs) => {
        updateRequest({
            url:`${URLS.statusofproduct}/${get(currentRecord,'_id')}`,attributes: {...attrs}
        },{
            onSuccess:()=>{
    ...
    const remove = (_id) => {
        removeRequest({url:`${URLS.statusofproduct}/${_id}`},{
            onSuccess:()=>{
                ref.current?.reload()
            }
        })
