...
const ProductGroupsPage = () => {
    ...
    const create = (attrs) => {
        mutate({url: URLS.groupsofproducts, attributes: {...attrs}}, {
            onSuccess: () => {
                setOpen(false)
                ref.current?.reload()
            }
    ...
    const update = (attrs) => {
        updateRequest({
            url:`${URLS.groupsofproducts}/${get(currentRecord,'_id')}`,attributes: {...attrs}
        },{
            onSuccess:()=>{
    ...
    const remove = (_id) => {
        removeRequest({url:`${URLS.groupsofproducts}/${_id}`},{
            onSuccess:()=>{
                ref.current?.reload()
            }
        })
