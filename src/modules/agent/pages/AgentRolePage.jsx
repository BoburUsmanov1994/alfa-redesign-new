...
const AgentRolePage = () => {
    ...
    const create = (attrs) => {
        mutate({url: URLS.accountroles, attributes: {...attrs}}, {
            onSuccess: () => {
                setOpen(false)
                ref.current?.reload()
            }
    ...
    const update = (attrs) => {
        updateRequest({
            url:`${URLS.accountroles}/${get(currentRecord,'_id')}`,attributes: {...attrs}
        },{
            onSuccess:()=>{
    ...
    const remove = (_id) => {
        removeRequest({url:`${URLS.accountroles}/${_id}`},{
            onSuccess:()=>{
                ref.current?.reload()
            }
        })
