...
const AgentStatusPage = () => {
    ...
    const create = (attrs) => {
        mutate({url: URLS.accountstatus, attributes: {...attrs}}, {
            onSuccess: () => {
                setOpen(false)
                ref.current?.reload()
            }
    ...
    const update = (attrs) => {
        updateRequest({
            url:`${URLS.accountstatus}/${get(currentRecord,'_id')}`,attributes: {...attrs}
        },{
            onSuccess:()=>{
    ...
    const remove = (_id) => {
        removeRequest({url:`${URLS.accountstatus}/${_id}`},{
            onSuccess:()=>{
                ref.current?.reload()
            }
        })
